...
Namespace NSSuiteCoreVbNet.Tests.Funcoes
    Public Class PreviaDocumento
        <Theory>
        <MemberData(NameOf(GetPrevias))>
        Public Sub RealizaUmaEmissaoSincronaDadoUmDFe(ByVal dfe As IPreviaReq)
            Try
        ...
        Public Shared ReadOnly Property GetPrevias As IEnumerable(Of Object())
            Get
